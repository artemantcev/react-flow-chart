...
function getOffset(config, data, zoom) {
...
exports.onDragNodeStop = function () { return __1.identity; };
...
exports.onDragCanvasStop = function () { return __1.identity; };
...
exports.onLinkComplete = function (props) {
    ...
    return function (chart) {
        if (!config.readonly &&
            (config.validateLink ? config.validateLink(__assign({}, props, { chart: chart })) : true) &&
...
exports.onNodeMouseEnter = function (_a) {
    var nodeId = _a.nodeId;
    return function (chart) {
        return __assign({}, chart, { hovered: {
                type: 'node',
                id: nodeId,
            } });
    };
};
exports.onNodeMouseLeave = function (_a) {
    var nodeId = _a.nodeId;
    return function (chart) {
...
exports.onDeleteKey = function (_a) {
...
exports.onCanvasDrop = function (_a) {
    var config = _a.config, data = _a.data, position = _a.position, id = _a.id;
    return function (chart) {
...
exports.onZoomCanvas = function (_a) {
    var config = _a.config, data = _a.data;
    return function (chart) {
        chart.offset = getOffset(config, { x: data.positionX, y: data.positionY });
